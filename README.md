...
- Chat drafts support Unicode-safe Left/Right, Home/End, Backspace, and Delete editing; long input stays on one row with the visible window centered around the logical cursor.
