...
describe("package metadata", () => {
  ...
  it("documents public installation, requirements, and local data boundaries", async () => {
    ...
    expect(readme).toContain("v0.4.6` is available from [npm]");
    ...
    expect(readme).toContain("1,402 tests across 146 files: 1,400 pass by default");
    ...
    expect(readme).toContain("--wait-timeout 600 --json");
    expect(readme).toContain("exit code `0` for `completed`");
    ...
    expect(readme).toContain("VERSION=0.4.6");
    expect(readme).toContain("package version `0.4.6` requires tag `v0.4.6`");
