...
describe("formatTuiThemePreview", () => {
  ...
  it("renders a catalog with every bundled theme and copyable palette values", () => {
    ...
    expect(catalog).toContain("codex: chrome=ansi256(234), surface=ansi256(235), rail=ansi256(237), accent=ansi256(81)");
    ...
    expect(catalog).toContain("aurora: chrome=ansi256(24), surface=ansi256(233), rail=ansi256(236), accent=ansi256(122)");
    expect(catalog).toContain("studio: chrome=ansi256(238), surface=ansi256(235), rail=ansi256(236), accent=ansi256(110)");
    expect(catalog).toContain("  palette:");
    expect(catalog).toContain("    chrome=ansi256(234), surface=ansi256(235), rail=ansi256(237)");
    expect(catalog).toContain("    text=ansi256(255), muted=ansi256(250), accent=ansi256(81)");
    expect(catalog).toContain("    successSurface=ansi256(22), success=ansi256(120), warning=ansi256(222)");
    ...
    expect(catalog).toContain("    chrome=ansi256(24), surface=ansi256(233), rail=ansi256(236)");
    expect(catalog).toContain("    text=ansi256(255), muted=ansi256(250), accent=ansi256(122)");
    expect(catalog).toContain("    successSurface=ansi256(29), success=ansi256(121), warning=ansi256(221)");
    expect(catalog).toContain("    dangerSurface=ansi256(52), danger=ansi256(210)");
    expect(catalog).toContain("    chrome=ansi256(238), surface=ansi256(235), rail=ansi256(236)");
    expect(catalog).toContain("    text=ansi256(254), muted=ansi256(247), accent=ansi256(110)");
    expect(catalog).toContain("    successSurface=ansi256(22), success=ansi256(151), warning=ansi256(214)");
    expect(catalog).toContain("    dangerSurface=ansi256(52), danger=ansi256(210)");
