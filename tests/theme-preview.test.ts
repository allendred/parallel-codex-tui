...
describe("formatTuiThemePreview", () => {
  ...
  it("renders a catalog with every bundled theme and copyable palette values", () => {
    ...
    expect(catalog).toContain("graphite: chrome=ansi256(236), surface=ansi256(233), rail=ansi256(238), accent=ansi256(117)");
    expect(catalog).toContain("paper: chrome=ansi256(254), surface=ansi256(231), rail=ansi256(255), accent=ansi256(25)");
    expect(catalog).toContain("aurora: chrome=ansi256(19), surface=ansi256(233), rail=ansi256(53), accent=ansi256(159)");
    ...
    expect(catalog).toContain("    text=ansi256(253), muted=ansi256(247), accent=ansi256(81)");
    ...
    expect(catalog).toContain("    text=ansi256(235), muted=ansi256(240), accent=ansi256(25)");
    ...
    expect(catalog).toContain("    chrome=ansi256(19), surface=ansi256(233), rail=ansi256(53)");
    ...
    expect(catalog).toContain("    text=ansi256(254), muted=ansi256(249), accent=ansi256(147)");
    expect(catalog).toContain("    successSurface=ansi256(22), success=ansi256(151), warning=ansi256(215)");
    expect(catalog).toContain("    dangerSurface=ansi256(52), danger=ansi256(217)");
