...
describe("formatTuiThemePreview", () => {
  ...
  it("renders a catalog with every bundled theme and copyable palette values", () => {
    ...
    expect(catalog).toContain("aurora: chrome=ansi256(23), surface=ansi256(234), rail=ansi256(237), accent=ansi256(80)");
    ...
    expect(catalog).toContain("    chrome=ansi256(23), surface=ansi256(234), rail=ansi256(237)");
    expect(catalog).toContain("    text=ansi256(255), muted=ansi256(250), accent=ansi256(80)");
